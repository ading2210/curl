...
#define CURLOPT_PROGRESSDATA CURLOPT_XFERINFODATA
  ...
  */
  ...
  /* allow resolution of .onion urls */
  CURLOPT(CURLOPT_IGNORE_ONION, CURLOPTTYPE_LONG, 329),
...
/* the typechecker does not work in C++ (yet) */
    ...
    !defined(__cplusplus) && !defined(__EMSCRIPTEN__) && !defined(CURL_DISABLE_TYPECHECK)
